...
interface RaceStartingGridPositionMapper : RecordUnmapper<StartingGridPosition, RaceDataRecord> {
    ...
    @Mapping(target = "startingGridPositionQualificationPositionNumber", source = "qualificationPositionNumber")
    @Mapping(target = "startingGridPositionQualificationPositionText", source = "qualificationPositionText")
    @Mapping(target = "startingGridPositionGridPenalty", source = "gridPenalty")
    @Mapping(target = "startingGridPositionGridPenaltyPositions", source = "gridPenaltyPositions")
    @Mapping(target = "startingGridPositionTime", source = "time")
    @Mapping(target = "startingGridPositionTimeMillis", source = "timeMillis")
    ...
    override fun unmap(source: StartingGridPosition): RaceDataRecord

    fun unmap(source: StartingGridPosition, type: RaceDataType): RaceDataRecord {
        return unmap(source).apply { setType(type.name) }
    }

    fun unmap(sources: List<StartingGridPosition>, type: RaceDataType): List<RaceDataRecord> {
