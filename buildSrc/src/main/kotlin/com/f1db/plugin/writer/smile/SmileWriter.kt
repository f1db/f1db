...
class SmileWriter(
    ...
    fun write() {
        ...
        write("$projectName-constructors-previous-next-constructors.sml", "splitted/$projectName-constructors-previous-next-constructors.schema.json", db.splitted.constructorPreviousNextConstructors)
