...
class JsonWriter(
    ...
    fun write() {
        ...
        write("$projectName-constructors-previous-next-constructors.json", "splitted/$projectName-constructors-previous-next-constructors.schema.json", db.splitted.constructorPreviousNextConstructors)
    ...
    private fun write(outputFileName: String, schemaFileName: String, value: Any) {
        ...
        val mapper = JsonMapper.builder()
            .defaultPrettyPrinter(
                DefaultPrettyPrinter()
                .withArrayIndenter(DefaultPrettyPrinter.NopIndenter())
