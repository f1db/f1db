...
class CsvWriter(
    ...
    fun write() {
        ...
        write("$projectName-constructors-chronology.csv", db.splitted.constructorChronology)
        write("$projectName-chassis.csv", db.splitted.chassis)
        write("$projectName-engine-manufacturers.csv", db.splitted.engineManufacturers)
        write("$projectName-engines.csv", db.splitted.engines)
        ...
        write("$projectName-seasons-entrants-chassis.csv", db.splitted.seasonEntrantChassis)
        write("$projectName-seasons-entrants-engines.csv", db.splitted.seasonEntrantEngines)
        ...
        write("$projectName-seasons-constructors.csv", db.splitted.seasonConstructors)
        write("$projectName-seasons-engine-manufacturers.csv", db.splitted.seasonEngineManufacturers)
        write("$projectName-seasons-tyre-manufacturers.csv", db.splitted.seasonTyreManufacturers)
        write("$projectName-seasons-drivers.csv", db.splitted.seasonDrivers)
