...
abstract class F1DBGenerateDistributionsTask : DefaultTask() {
    ...
    @get:Internal
    abstract val currentSeason: Property<Int>

    @get:Internal
    abstract val currentSeasonFinished: Property<Boolean>
    ...
    @TaskAction
    fun generate() {
        val db = F1DBReader(sourceDir.get().asFile, currentSeason.get(), currentSeasonFinished.get()).read()
        F1DBWriter(outputDir.get().asFile, formats.get(), db).write()
    }
}
